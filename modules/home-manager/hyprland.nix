...
{
  # 1. Enable the Hyprland program and define its basic settings
  programs.hyprland = {
    enable = true;
    xwayland.enable = true; # Needed for X11 compatibility
    
    # Define extra packages you want available in the Hyprland session
    ...
    # 2. Define the main Hyprland configuration
    # This is a string that gets written to ~/.config/hypr/hyprland.conf
    settings = {
  ...
  # 3. Basic Wallpaper setup using hyprpaper (requires an image in your system)
  services.hyprpaper = {
    enable = true;
    settings = {
